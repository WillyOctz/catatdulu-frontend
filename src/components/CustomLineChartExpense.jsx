      ...
      return (
        <div className="bg-white p-3 border border-gray-200 rounded-lg shadow-lg">
          ...
          <p className="text-sm text-gray-600">
            Total: -Rp.{formatIndonesian(payload[0].value * -1)}
          </p>
        ...
        >
          <defs>
            <linearGradient id="colorExpense" x1="0" y1="0" x2="0" y2="1">
              <stop offset="5%" stopColor="#e82727" stopOpacity={0} />
              <stop offset="95%" stopColor="#e82727" stopOpacity={0.3} />
            </linearGradient>
          </defs>
          ...
          <Line
            ...
            stroke="#e82727"
            strokeWidth={3}
            dot={{ fill: "#141414", strokeWidth: 1, r: 4 }}
            activeDot={{ r: 7, fill: "#454444" }}
          />
        </ComposedChart>
      </ResponsiveContainer>
